import {APIResponseType, ItemsResponseType, ResultCodeEnum, usersAPI} from '../Api/Api'
...
export const follow = (userId: number, fakeMethod: any):AppThunkType => async (dispatch) => {
